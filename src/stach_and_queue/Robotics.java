...
public class Robotics {
    ...
    static LocalDateTime getLocalDateTime(HashMap<String, Robot> allRobots, DateTimeFormatter formatter, LocalDateTime starTime, ArrayDeque<String> products, String product) {
